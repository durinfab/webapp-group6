/**
 * @fileOverview  The model class Author with property definitions, (class-level)
...
class Author {
  ...
  set authorId( id) {
    const constraintViolation = Author.checkAuthorIdAsId( id);
    if (constraintViolation instanceof NoConstraintViolation) {
 ...
 *  Since the book-author association is unidirectional, a linear search on all
 *  books is required for being able to delete the author from the books' authors.
 */
